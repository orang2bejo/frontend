...
// Define a type for the navigation prop based on your navigation stack
// Replace 'RootStackParamList' with the actual name of your root stack param list type
// If you don't have a root stack param list type defined, you might need to create one
type RootStackParamList = {
  HelpCenter: undefined; // Example: If HelpCenter has no parameters
  // Add other screen names and their parameter types here
  // For example: AnotherScreen: { userId: string };
};
